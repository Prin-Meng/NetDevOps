...
class Devicedb(models.Model):
    ...
    # SNMP读写Community
    snmp_rw_community = models.CharField(max_length=999, blank=False, verbose_name='读写SNMP Community')
    # SSH用户名
    ...
    # 特权密码(ASA必须设置)
    enable_password = models.CharField(max_length=999, blank=False, verbose_name='Enable密码')
    # 修改时间
    change_datetime = models.DateTimeField(null=True, auto_now=True)
    # 创建时间
    create_datetime = models.DateTimeField(null=True, auto_now_add=True)
