...
135	Mobility Header
136	UDPLite
137	MPLS-in-IP'''.replace('	', ":")

y = [('0', 'HOPOPT'), ('1', 'ICMP'), ('2', 'IGMP'), ('3', 'GGP'), ('6', 'TCP'), ('7', 'CBT'), ('8', 'EGP'),
     ('9', 'IGP'), ('10', 'BBN-RCC-MON'), ('11', 'NVP-II'), ('12', 'PUP'), ('13', 'ARGUS'), ('14', 'EMCON'),
