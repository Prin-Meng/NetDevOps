from network_protocal.task_day1.get_ip_netifaces import get_ip_address
...
def analysis(info):
    ...
    if '1.3.6.1.2.1.14.10.1.6' in info.keys():
        if info["1.3.6.1.2.1.14.10.1.6"]['integer-value'] == '8':
            print('OSPF Neighbor', info["1.3.6.1.2.1.14.10.1.3"]['ipAddress-value'], "FULL")
        elif info["1.3.6.1.2.1.14.10.1.6"]['integer-value'] == '1':
            print('OSPF Neighbor', info["1.3.6.1.2.1.14.10.1.3"]['ipAddress-value'], "Down")
