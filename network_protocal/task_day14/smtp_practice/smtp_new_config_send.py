...
import smtplib
import email.utils
from get_dev_config_info import write_config_md5_to_db
from email.mime.multipart import MIMEMultipart
from email.mime.text import MIMEText
from email.mime.application import MIMEApplication


def prin_smtp(mailserver, username, password, from_mail, to_mail, subj, main_body, files=None):
...
if __name__ == '__main__':
    ...
    dev_info = write_config_md5_to_db('192.168.0.109', 'prin', 'Cisc0123', 'dev_info')
    # 如果配置改变
    if dev_info:
        prin_smtp('smtp.qq.com',
                  # 登陆邮箱
                  '772062725@qq.com',
                  'shkpglcttfljbaia',
                  # 发送信件的邮箱需要和登陆邮箱相同
